...
bool decision(int x, int target, Result& res) {
    ...
    int costs[3];
    costs[0] = mShipFee + minCost[0][0].mCost + minCost[0][1].mCost + minCost[0][2].mCost;
    costs[1] = mShipFee + minCost[1][1].mCost + minCost[1][1].mCost + minCost[2][2].mCost;
    costs[2] = mShipFee * 2 + min(minCost[0][0].mCost, minCost[1][0].mCost)
                            + min(minCost[0][1].mCost, minCost[1][1].mCost)
                            + min(minCost[0][2].mCost, minCost[1][2].mCost);
